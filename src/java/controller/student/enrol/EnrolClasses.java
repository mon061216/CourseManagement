 ...
 */
package controller.student.enrol;
 ...
 * @author PC
 */
public class EnrolClasses extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            EnrolDTO enrol = new EnrolDTO(userID, classID, new Date(), true, "New enrol");
            dao.create(enrol);
            request.setAttribute("MSG", "Enroll successful!");
            request.getRequestDispatcher("MainController?action=MyClasses").forward(request, response);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
